      ...
      return (
        ...
        >
          <div className={multiClass} onClick={this.toggle.bind(this)}>
            {selectOptions.map((tag, index) => {
              if (tag.checked)
                return (
                  <Tag
                    key={tag.value}
                    onClose={this.deleteTag.bind(this, index)}
                  >
                    {tag.value}
                  </Tag>
                );
            ...
            <Icon name={showOptions ? "chevron-up" : "chevron-down"} />
          </div>
      ...
      return (
        ...
        >
          <Input
            ...
            onChange={this.inputChangeHanlder.bind(this)}
          />
          {showOptions && SelectOptions}
        </div>
      );
